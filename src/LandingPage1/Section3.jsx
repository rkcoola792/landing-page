...
const Section3 = () => {
  return (
    <div className='section3 my-12 flex flex-col gap-12 '>
      <div className='top flex flex-col gap-2 text-center'>
        <h3 className='font-bold text-base lg:text-xl'>What We Offer</h3>
        <h3 className='text-mainRed text-2xl lg:text-3xl font-semibold'>Where Strategy Meets Digital. </h3>
        <h3 className='text-2xl lg:text-3xl font-semibold'>Your Success Story Begins with Media Dynox.</h3>
      </div>
