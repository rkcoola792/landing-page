...
const Hero = () => {
  return (
    ...
    <div className='bg-red flex flex-col justify-center items-center text-center md:flex-row md:justify-between md:text-left md:items-center my-12 md:mt-24 '>
      <div className='left md:w-[70%]  flex flex-col gap-4'>
        ...
        <div className='star-subheading relative'>
            <div className='absolute w-12 right-72  top-12 hidden md:block'>
      ...
      <div className='right md:w-[40%] w-[100%]'>
       <Form></Form>
      </div>
